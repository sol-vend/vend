                ...
                <div className="app-home geist-geist-font">
                    <div className="top-section">
                        ...
                        <div
                            ...
                            onClick={() => setSelectedRoute(<VendorApp />)}
                        >
                        ...
                        <div className="buy">
                            ...
                            <div className="buy-subtext">
                                Use Solana tokens for purchases
                            </div>
                        </div>
                    ...
                    <div className="about-us-section">
                        ...
                        <div className="about-us-text">
                            ...
                            practical for everyone. We are dedicated to empowering individuals with
                            seamless payment solutions built on the Solana blockchain, enabling
                            fast, secure, and cost-effective transactions for both mainstream users
                            and meme coin enthusiasts. By bridging the gap between cutting-edge
                            blockchain technology and real-world usability, we strive to create a
                            future where sending and receiving crypto payments is as simple and
                            commonplace as using traditional money. Together, we’re building a
                            more inclusive financial ecosystem—one transaction at a time.
                        </div>
                    ...
                    <div>
                        ...
                        {fetchedTokens &&
                            <TokenTicker tokens={fetchedTokens} />
                        }
                    </div>
