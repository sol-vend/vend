...
const SnapSlider = ({
  ...
  const getItemOffset = (index) => {
    ...
    if (additionalTranslation != null){
        return centerOffset - index * (itemWidth + gap) - (additionalTranslation / 3);
    }
  ...
  useEffect(() => {
    ...
    containerElement.addEventListener("touchmove", handleTouchMoveNonPassive, {
      passive: false,
    });
    containerElement.addEventListener("touchend", handleTouchEndNonPassive, {
      passive: false,
    });
  ...
  return (
    <div
      ...
      style={{
        transform: isActive ? "scale(1.1)" : "scale(1.00)",
      ...
      {containerRef.current && (
        <div
          ...
          style={{
            ...
            transition:
              touchPosition === null ? "transform 0.3s ease-out" : "none",
            gap: `${gap}px`,
          }}
        >
