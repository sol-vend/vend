      ...
      <div className="home-home-outer-wrapper" ref={elementRef}>
        ...
        <div className="home-home-top-banner">
          {loginInformation && loginInformation.user_id && (
            <p style={{ position:'absolute', top: isMobileDevice ? "120px" : "120px", textAlign:'end', fontSize:"0.75rem", width: isMobileDevice ? "93vw" : "97vw",  }}>
        ...
        <div style={{ position: "relative" }}>
          <div className="home-home-primary-content">
            ...
            <div className="home-home-center-content">
              <div
                className={"home-home-center-header carousel-controls header-carousel swipeable"}
                    ...
                    <>
                      ...
                      >
                        <SwipeIndicator
                          ...
                          numArrows={5}
                          size={12}
                          maxIndex={selectedOptionCard.selectedIndex === selectedOptionCard.headerOpts.length - 1}
                        />
                      </button>
                    </>
                  )}
