...
const PaypalOptions = ({ parentSetWalletAddress, walletAddress = "" }) => {
  console.log(walletAddress);
  const initialWalletState =
    walletAddress === ""
      ? { walletAddress: "", isAddressValid: false }
      : { walletAddress: walletAddress, isAddressValid: true };

  const [walletAddressDatas, setWalletAddressDatas] =
    useState(initialWalletState);
  ...
  useEffect(() => {
    ...
    if (walletAddress) {
      setWalletAddressDatas({
        ...
        isAddressValid: solanaAddressRegex.test(walletAddress),
      });
    }
  }, [walletAddress]);
  ...
  console.log(walletAddressDatas);
  return (
    <div>
      <div className="vendor-input-field-styles">
        <label
          htmlFor="walletAddress"
          style={{ display: "block", fontWeight: "bold", marginTop: "15px" }}
        >
          Wallet Address:
        </label>
          ...
          >
            {walletAddressDatas.walletAddress.length ? (
              ...
              >
                ...
                <path
                  d="M30,12H26v2h4v2h2V14A2,2,0,0,0,30,12Z"
                ...
                ></rect>
                <path
                  d="M30,30H28v2h2a2,2,0,0,0,2-2V26H30Z"
                ...
                ></rect>
                <path
                  d="M14,26H12v4a2,2,0,0,0,2,2h4V30H14Z"
        ...
        {!walletAddressDatas.isAddressValid &&
          walletAddressDatas.walletAddress && (
            <p style={{ color: "red", fontSize: "14px", marginTop: "8px" }}>
              Invalid wallet address. Please <strong>paste</strong> your
              address.
            </p>
          )}
        <p
